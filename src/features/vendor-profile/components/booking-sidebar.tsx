  ...
  return (
    <div className="card-soft p-6 sticky top-20">
      ...
      <div className="mt-5 space-y-2">
        ...
        >
          <Calendar className="size-4" />Request to book
        </Link>
      ...
      <div className="mt-5 text-xs text-muted-foreground space-y-1.5">
        <div className="flex items-center gap-2">
          <ShieldCheck className="size-3.5 text-teal" />Payment held in escrow until job is done
        </div>
        <div className="flex items-center gap-2">
          <CheckCircle2 className="size-3.5 text-success" />Free cancellation up to 24h
        </div>
        <div className="flex items-center gap-2">
          <Award className="size-3.5 text-amber" />Backed by JaldiHelp Guarantee
        </div>
      </div>
    </div>
  );
