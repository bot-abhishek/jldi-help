  ...
  return (
    <aside className="space-y-6">
      <div className="card-soft p-5">
        ...
        <FilterGroup title="Availability" options={["Available today", "This week", "Specific date"]} />
        <FilterGroup title="Price range" options={["€ Under 50", "€€ 50–150", "€€€ 150–500", "€€€€ 500+"]} />
        <FilterGroup title="Minimum rating" options={["4.5+", "4.0+", "3.5+"]} />
        <FilterGroup title="Verification tier" options={["Background-checked", "Credential-verified", "ID-verified"]} />
        <FilterGroup title="Language" options={["English", "Polish", "Hindi", "Portuguese", "Tagalog", "Arabic"]} />
