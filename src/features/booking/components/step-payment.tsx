  ...
  return (
    <section className="mt-10">
      <h2 className="font-display text-2xl mb-4 flex items-center gap-3">
        <span className="size-8 grid place-items-center rounded-full bg-ink text-cream text-sm num-pill">
          4
        </span>
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        ...
        >
          ...
          <div className="text-xs text-muted-foreground mt-1">
            Charged when the job is marked complete
          </div>
        </button>
        <button
        ...
        >
          ...
          <div className="text-xs text-muted-foreground mt-1">
            Not protected by JaldiHelp Guarantee
          </div>
        </button>
      </div>
      ...
      {selected === "card" && (
        <div className="mt-4 card-soft p-5 space-y-3">
          ...
          <div className="text-xs text-muted-foreground flex items-center gap-1.5">
            ...
            Secured by Stripe · Funds held in escrow until job complete
          </div>
        </div>
      )}
    </section>
