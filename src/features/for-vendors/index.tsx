...
const FEATURES = [
  {
    i: TrendingUp,
    t: "Smart placement",
    b: "Our matching engine ranks you by trust, response time and proximity — not who pays most.",
  },
  {
    i: Calendar,
    t: "Calendar that's yours",
    b: "Sync with Google or Apple Calendar. Block off times in one tap. Auto-decline outside hours.",
  },
  {
    i: CreditCard,
    t: "Get paid fast",
    b: "Payments land in your account within 2 business days of completion. Direct to your IBAN.",
  },
  {
    i: ShieldCheck,
    t: "Verification that helps",
    b: "Pass our verification once — wear the badge forever. Background-checked vendors get 3× more bookings.",
  },
  {
    i: Star,
    t: "A portable reputation",
    b: "Your reviews are yours. Embed them on your own site, share via WhatsApp, take them with you.",
  },
  {
    i: Zap,
    t: "Instant-book or request",
    b: "Choose per service whether customers can book directly or have to request first.",
  },
];
...
const TIERS = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Unlimited bookings",
      "Escrow payments",
      "JaldiHelp Guarantee for customers",
        ...
        <div className="container-x py-20 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-5 text-lg text-muted-foreground max-w-xl">
              List your service in 10 minutes. No monthly fees, no contracts. Pay a flat 18% only
              when you get booked — Ireland&apos;s most vendor-friendly commission.
            </p>
              ...
              {EARNINGS.map((r) => (
                <div key={r.c}>
                  <div className="flex justify-between text-sm font-medium">
                    <span>{r.c}</span>
                    <span className="num-pill">{r.k}</span>
                  </div>
      ...
      <section className="container-x pb-20">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {TIERS.map((p) => (
            <div
              key={p.tier}
              className={"card-soft p-7 flex flex-col " + (p.featured ? "ring-2 ring-teal" : "")}
            >
              ...
              <button
                className={
                  "mt-5 px-5 py-3 rounded-xl text-sm font-semibold " +
