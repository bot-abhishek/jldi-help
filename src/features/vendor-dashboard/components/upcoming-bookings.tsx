  ...
  return (
    <div className="lg:col-span-2 card-soft p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="text-sm font-semibold underline-offset-4 hover:underline">
          View calendar →
        </button>
      </div>
      <div className="divide-y divide-border">
        {UPCOMING.map((b, i) => (
          <div key={i} className="py-4 flex items-center gap-4 flex-wrap">
            ...
            <span className={"pill " + (b.status === "Confirmed" ? "chip-teal" : "chip-amber")}>
              {b.status}
            </span>
          </div>
        ))}
