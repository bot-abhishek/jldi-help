    ...
    <PageLayout>
      ...
      <section className="container-x py-16 grid md:grid-cols-2 gap-10">
        <div>
          ...
          <p className="mt-3 text-muted-foreground">Finding a trustworthy plumber, an Afro-hair specialist or a Punjabi-speaking pandit currently means scrolling Facebook groups, calling three numbers off a flyer, and praying. There's no shared infrastructure for trust, pricing, booking, payment or accountability across the long tail of local services.</p>
          <p className="mt-3 text-muted-foreground">We're building it — for every category a household needs, including the cultural and religious services no other marketplace has touched.</p>
        </div>
        <div>
      ...
      <section className="container-x pb-20">
        <div className="card-soft p-10 text-center">
          ...
          <p className="text-muted-foreground mt-2">We have a four-document product specification covering foundation, modules, journeys & technical spec, and the full category taxonomy.</p>
          <Link to="/for-vendors" className="mt-5 inline-flex px-6 py-3.5 rounded-full bg-ink text-cream font-semibold text-sm">Talk to the founders</Link>
        </div>
      </section>
    </PageLayout>
  ),
